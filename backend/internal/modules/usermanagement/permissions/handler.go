...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	auditlogs.LogAuditWithID(r.Context(), r, h.auditLog, "user_management", "create", "permission", item.ID, userID, item)
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	auditlogs.LogAuditWithID(r.Context(), r, h.auditLog, "user_management", "update", "permission", item.ID, userID, item)
	response.JSON(w, http.StatusOK, map[string]any{"success": true, "data": item})
}
...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	auditlogs.LogAuditWithID(r.Context(), r, h.auditLog, "user_management", "delete", "permission", id, userID, nil)
