...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	auditlogs.LogAuditWithID(r.Context(), r, h.auditLog, "student_affairs", "create", "student_enrollment", created.ID, userID, req)
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	auditlogs.LogAuditWithID(r.Context(), r, h.auditLog, "student_affairs", "update", "student_enrollment", id, userID, req)
...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	auditlogs.LogAuditWithID(r.Context(), r, h.auditLog, "student_affairs", "delete", "student_enrollment", id, userID, nil)
