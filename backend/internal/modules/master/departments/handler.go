...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	auditlogs.LogAuditWithID(r.Context(), r, h.auditLog, "master", "create", "department", created.ID, userID, req)
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	auditlogs.LogAuditWithID(r.Context(), r, h.auditLog, "master", "update", "department", updated.ID, userID, req)
...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	auditlogs.LogAuditWithID(r.Context(), r, h.auditLog, "master", "delete", "department", id, userID, nil)
